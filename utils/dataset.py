...
class MyDataset(Dataset):
    def __init__(self, data_dir, transform=None, csv_path=None):
        ...
        self.img_dir = sorted(glob.glob(os.path.join(data_dir, "train/*.jpg")))
